...
public class Activity_2 {
    ...
    public void TestGoogleKeep() {
        ...
        // Assertion
        wait.until(ExpectedConditions.visibilityOfElementLocated(MobileBy.id("com.google.android.keep:id/index_note_text_description")));
        String Note = driver.findElementById("com.google.android.keep:id/index_note_text_description").getText();
        Assert.assertEquals(Note, "Test Notes");
    }
